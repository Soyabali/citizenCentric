...
import 'markGeotaggingform.dart';

class ParkGeotagging extends StatefulWidget {
  const ParkGeotagging({super.key});

  @override
  State<ParkGeotagging> createState() => _DashboardScreenState();
}
        ...
        child: Container(
          ...
          child: Container(
            constraints: const BoxConstraints(
              minHeight: 60, // ✅ minimum height, auto-expand if needed
            ),
            decoration: BoxDecoration(
              color: Colors.white,
              border: Border(
            ...
            child: ClipRRect(
              ...
              child: ListTile(
                dense: true,
                isThreeLine: true, // ✅ allows proper vertical expansion
                ...
                trailing: Container(
                  width: 120,
                  padding: const EdgeInsets.symmetric(vertical: 6), // ✅ auto height
                             ...
                             onTap: () {
                               ...
                               Navigator.push(
                                 ...
                                 MaterialPageRoute<void>(
                                   builder: (context) => ParkGeotaggingForm(
                                     parkName: parkName,
                                     parkId: parkId,
                                   ),
                                 ),
