...
class HomeViewModel extends BaseViewModel implements HomeViewModelInputs,HomeViewModelOutputs {
  ...
  var stfffListObject = StaffListObject(sEmpCode: "");
  ...
  _getHome() async {
    ...
    // argument in this class, if you need then you should enter
    // as a login api
    ...
    (await _staffListUseCase.execute(StaffListInput(stfffListObject.sEmpCode))).fold(
        (failure) {
          ...
          inputState.add(ContentState());// here i add a StateRendertype here i pass no rendered
