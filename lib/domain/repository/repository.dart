...
abstract class Repository {
  ...
  // Every api repository put here , but you should carefully understand what class put in this syntax
  ...
  // {{<Failure,Authentication>}}, here you should clear Failure is a class that give us , code and msg of any api
  ...
  // // -----InspectionList----.
  // Future<Either<Failure,List<InspectionStatusModel>>> inspectionList(InspectionListRequest inspectionListRequest);
 // Future<List<StafListResponse>> getStaffList();
 // Future<List<InspectionStatusItemResponse>> getInspectionList();
  Future<Either<Failure, List<InspectionStatusModel>>> inspectionList(InspectionListRequest request);
  // Countdashboard

  Future<Either<Failure, CountDashboardModel>> countDashboard(CountDashboardRequest request);
  //  AgencyWise Details
  Future<Either<Failure, List<ParkListByAgencyModel>>> parkListByAgency(ParkListByAgencyRequest request);
